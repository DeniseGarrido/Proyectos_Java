...
public class Penjat {
    ...
    private final String NOM_IMG = "aah.jpg"; // nom del fitxer, ha d’estar en el mateix paquet que Penjat.java
    private final int AMPLE = 420; // amplada d’una imatge
    private final int ALT = 550; // alçada d’una imatge
