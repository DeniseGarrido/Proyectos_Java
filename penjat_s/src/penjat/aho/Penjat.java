...
public class Penjat {
    ...
    private final int MAX_FALLADES = 9; // nombre de fallades màximes
    private final String NOM_IMG = "sahorcado.jpg"; // nom del fitxer, ha d’estar en el mateix paquet que Penjat.java
    private final int AMPLE = 470; // amplada d’una imatge
    private final int ALT = 644; // alçada d’una imatge
