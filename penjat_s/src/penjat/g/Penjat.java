...
public class Penjat {
    ...
    private final int MAX_FALLADES = 7; // nombre de fallades màximes
    private final String NOM_IMG = "penjatg.jpg"; // nom del fitxer, ha d’estar en el mateix paquet que Penjat.java
    private final int AMPLE = 255; // amplada d’una imatge
    private final int ALT = 400; // alçada d’una imatge
